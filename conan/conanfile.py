...
class ReportportalclientcppConan(ConanFile):
    name = "reportportal-agent-googletest"
    license = "Apache-2.0"
    author = "Maxx Boehme"
    url = "https://github.com/maxxboehme/reportportal-agent-googletest"
    description = "GoogleTest agent for ReportPortal.io"
    topics = ("reportportal")
    ...
    requires = "reportportal-client-cpp/[>0.0.1 <1.0]+master@maxxboehme/testing", "gtest/1.10.0"
